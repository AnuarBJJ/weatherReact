...
/***/ function(module, exports, __webpack_require__) {
	...
	var WeatherInfo = __webpack_require__(220);
	  ...
	  render: function render() {
	    ...
	    function renderInfo() {
	      ...
	      if (that.state.isLoading) {
	        ...
	        return React.createElement(WeatherInfo, { city: that.state.location, temp: that.state.temp });
	      }
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var OPEN_WEATHER_MAP_URL = 'http://api.openweathermap.org/data/2.5/weather?&appid=c94c16121542dc8bf7a0184ea5de9c6f&units=imperial';
